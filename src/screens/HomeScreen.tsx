...
export const HomeScreen: React.FC<HomeScreenProps> = ({ onLogoPress }) => {
  ...
  const genreCards = [
    {
      name: 'Midnight Lo-Fi',
      desc: 'Study & chill beats',
      image: 'lofi_city',
      track: CURATED_TRACKS[0],
    },
    {
      name: 'Neon Synthwave',
      desc: 'Retro 80s electronic drive',
      image: 'synthwave_grid',
      track: CURATED_TRACKS[1],
    },
    {
      name: 'Acoustic Resonance',
      desc: 'Pure guitar & morning warmth',
      image: 'acoustic_morning',
      track: CURATED_TRACKS[2],
    },
    {
      name: 'Astral Ambient',
      desc: 'Deep cosmic meditations',
      image: 'ambient_astral',
      track: CURATED_TRACKS[3],
    },
    {
      name: 'Electric Pulse',
      desc: 'Festival laser basslines',
      image: 'edm_pulse',
      track: CURATED_TRACKS[4],
    },
    {
      name: 'Urban Vinyl',
      desc: '90s boombox boom bap',
      image: 'hiphop_street',
